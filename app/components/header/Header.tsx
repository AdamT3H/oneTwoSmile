          ...
          <nav className={styles.burger}>
            <Link
              ...
              className={`${styles.burgerOptionsMain} ${
                pathname === "/" ? styles.burgerOptionsMainActive : ""
              }`}
            >
              Головна
            </Link>
            ...
            <Link
              ...
              className={`${styles.burgerOptionsTeam} ${
                pathname === "/ourTeam" ? styles.burgerOptionsTeamActive : ""
              }`}
            >
              Наша команда
            </Link>
            ...
            <Link
              ...
              className={`${styles.burgerOptionsService} ${
                pathname === "/service" ? styles.burgerOptionsServiceActive : ""
              }`}
            >
              Наші послуги
            </Link>
